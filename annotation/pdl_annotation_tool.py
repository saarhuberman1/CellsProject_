        ...
        while 0 <= self.curr_idx < len(self.images):
            ...
            try:
                if pd.isna(im):
                    ...
                    cv2.putText(self.curr_im, f'No Matching {self.modes[self.curr_mode]} Image', (2256 // 6, 1440 // 2 - 100), font, 4, (0, 0, 1), 5,
                                cv2.LINE_AA)
                else:
                ...
                cv2.putText(self.curr_im, f'{self.curr_idx + 1}/{num_imgs}', (35, 125), font, 1, (0, 0, 0), 2,
                            cv2.LINE_AA)
                # cv2.putText(self.curr_im, f'{os.path.basename(self.curr_im_path)}', (35, 165), font, 0.7, (0, 0, 0), 2,
                #             cv2.LINE_AA)
...
if __name__ == '__main__':
    ...
    # excel_file = r"C:\Users\amirlivn\Downloads\bliss\for_annotation\ER_annotations_debug.xlsx"
    # excel_file = r"C:\Users\amirlivn\Downloads\bliss\for_annotation\02-008-annotations.xlsx"
...
# WORKING CMD:
# annotation_tool.exe --excel_file "C:\Users\A Polonia\Desktop\GIL_PDL1\Antonio_Annotations_PDL1_02-008.xlsx" --root_images_dir "C:\Users\A Polonia\Desktop\GIL_PDL1\PDL1(SP142)-Springbio\\"
